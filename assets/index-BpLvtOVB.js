...
`,R=()=>{const e=r();return w.jsx(O,{children:w.jsxs(P,{children:[w.jsx(j,{children:"TRÁILERFLIX"}),w.jsxs(E,{children:[w.jsx(S,{to:"/",primary:"/"===e.pathname?1:0,children:"Hogar"}),w.jsx(S,{to:"/new-video",primary:"/new-video"===e.pathname?1:0,children:"Nuevo Video"})]})]})})},T=u.footer`
  width: 100%;
  background: #13111b;
  padding: 3rem 1rem;
  position: relative;
...
`,Wr=u.p`
  ...
  color: #a8a8b3;
  margin: 0;
`,Jr=({video:e,onClose:t})=>w.jsx(Fr,{onClick:t,children:w.jsxs(qr,{onClick:e=>e.stopPropagation(),children:[w.jsx(Vr,{onClick:t,children:"×"}),w.jsx(Br,{url:e.url}),w.jsxs($r,{children:[w.jsx(Hr,{children:e.title}),w.jsx(Wr,{children:e.description})]})]})}),Kr=u.div`
  position: relative;
  width: 100%;
  aspect-ratio: 16/9;
  border-radius: 12px;
