const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Preview-CHwI0C34.js","assets/react-vendor-DIpr6rjO.js"])))=>i.map(i=>d[i]);
import{a as e,b as t,u as r,L as n,g as o,c as i,d as a,r as s,e as l,B as c,R as d,f as u,N as p}from"./react-vendor-DIpr6rjO.js";import{d as f,m as h}from"./styled-D8dYhnpr.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver((e=>{for(const r of e)if("childList"===r.type)for(const e of r.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&t(e)})).observe(document,{childList:!0,subtree:!0})}function t(e){if(e.ep)return;e.ep=!0;const t=function(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?t.credentials="include":"anonymous"===e.crossOrigin?t.credentials="omit":t.credentials="same-origin",t}(e);fetch(e.href,t)}}();var m,y,g={exports:{}},b={};var w,x=(y||(y=1,g.exports=function(){if(m)return b;m=1;var t=e(),r=Symbol.for("react.element"),n=Symbol.for("react.fragment"),o=Object.prototype.hasOwnProperty,i=t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,a={key:!0,ref:!0,__self:!0,__source:!0};function s(e,t,n){var s,l={},c=null,d=null;for(s in void 0!==n&&(c=""+n),void 0!==t.key&&(c=""+t.key),void 0!==t.ref&&(d=t.ref),t)o.call(t,s)&&!a.hasOwnProperty(s)&&(l[s]=t[s]);if(e&&e.defaultProps)for(s in t=e.defaultProps)void 0===l[s]&&(l[s]=t[s]);return{$$typeof:r,type:e,key:c,ref:d,props:l,_owner:i.current}}return b.Fragment=n,b.jsx=s,b.jsxs=s,b}()),g.exports),v={};var O=function(){if(w)return v;w=1;var e=t();return v.createRoot=e.createRoot,v.hydrateRoot=e.hydrateRoot,v}();const P=f.header`
...
`,R=f(n)`
  background: ${e=>e.active?"#9b6dff":"transparent"};
  color: ${e=>e.active?"white":"#9b6dff"};
  padding: 0.5rem 1rem;
  border-radius: 8px;
...
`,T=()=>{const e=r();return x.jsx(P,{children:x.jsxs(j,{children:[x.jsx(E,{children:"TRÁILERFLIX"}),x.jsxs(S,{children:[x.jsx(R,{to:"/",active:"/"===e.pathname?1:0,children:"Hogar"}),x.jsx(R,{to:"/new-video",active:"/new-video"===e.pathname?1:0,children:"Nuevo Video"})]})]})})},k=f.footer`
  width: 100%;
...
`,Jr=f.p`
  ...
  color: #a8a8b3;
  margin: 0;
`,Kr=({video:e,onClose:t})=>x.jsx(qr,{onClick:t,children:x.jsxs(Vr,{onClick:e=>e.stopPropagation(),children:[x.jsx($r,{onClick:t,children:"×"}),x.jsx(Fr,{url:e.url}),x.jsxs(Hr,{children:[x.jsx(Wr,{children:e.title}),x.jsx(Jr,{children:e.description})]})]})}),Yr=f.div`
  position: relative;
  width: 100%;
  aspect-ratio: 16/9;
  border-radius: 12px;
...
`,_n=f.div`
  ...
  width: 100%;
  aspect-ratio: 16/9;
`,Cn=()=>{var e;const t=l(),n=null==(e=r().state)?void 0:e.editVideo,[o,i]=s.useState({title:"",category:"",url:"",description:""}),[a,c]=s.useState(""),[d,u]=s.useState(!1);s.useEffect((()=>{n&&i({title:n.title||"",category:n.category||"",url:n.url||"",description:n.description||""})}),[n]);const p=e=>{const{name:t,value:r}=e.target;i((e=>({...e,[t]:r})))};return x.jsx(xn,{children:x.jsxs(vn,{children:[x.jsx(On,{children:n?"Editar Video":"Nuevo Video"}),x.jsxs(Pn,{onSubmit:async e=>{e.preventDefault(),u(!0),c("");try{n?await $t.put(`${Ht}/${n.id}`,o):await $t.post(Ht,o),t("/")}catch(r){console.error("Error:",r),c("Error al guardar el video. Por favor, intenta de nuevo.")}finally{u(!1)}},children:[x.jsxs(jn,{children:[x.jsx(En,{htmlFor:"title",children:"Título"}),x.jsx(Sn,{type:"text",id:"title",name:"title",value:o.title,onChange:p,required:!0})]}),x.jsxs(jn,{children:[x.jsx(En,{htmlFor:"category",children:"Categoría"}),x.jsxs(Rn,{id:"category",name:"category",value:o.category,onChange:p,required:!0,children:[x.jsx("option",{value:"",children:"Selecciona una categoría"}),x.jsx("option",{value:"Películas",children:"Películas"}),x.jsx("option",{value:"Series",children:"Series"}),x.jsx("option",{value:"Documentales",children:"Documentales"}),x.jsx("option",{value:"Anime",children:"Anime"})]})]}),x.jsxs(jn,{children:[x.jsx(En,{htmlFor:"url",children:"URL del Video (YouTube)"}),x.jsx(Sn,{type:"url",id:"url",name:"url",value:o.url,onChange:p,required:!0})]}),x.jsxs(jn,{children:[x.jsx(En,{htmlFor:"description",children:"Descripción"}),x.jsx(Tn,{id:"description",name:"description",value:o.description,onChange:p,required:!0})]}),a&&x.jsx(An,{children:a}),o.url&&x.jsx(_n,{children:x.jsx(Fr,{url:o.url})}),x.jsx(kn,{type:"submit",disabled:d,children:d?"Guardando...":n?"Guardar Cambios":"Crear Video"})]})]})})},Ln=f.div`
  min-height: 100vh;
  width: 100%;
  display: flex;
  flex-direction: column;
...
`;function Un(){return x.jsx(c,{basename:"/trailerflix",children:x.jsxs(Ln,{children:[x.jsx(T,{}),x.jsx(Dn,{children:x.jsxs(d,{children:[x.jsx(u,{path:"/",element:x.jsx(wn,{})}),x.jsx(u,{path:"/new-video",element:x.jsx(Cn,{})}),x.jsx(u,{path:"/edit-video",element:x.jsx(Cn,{})}),x.jsx(u,{path:"*",element:x.jsx(p,{to:"/",replace:!0})})]})}),x.jsx(I,{})]})})}O.createRoot(document.getElementById("root")).render(x.jsx(s.StrictMode,{children:x.jsx(Un,{})}));
//# sourceMappingURL=index-BNkMUhse.js.map
