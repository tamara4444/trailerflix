...
`,_n=p.div`
  ...
  width: 100%;
  aspect-ratio: 16/9;
`,Cn=()=>{var e;const t=s(),r=null==(e=n().state)?void 0:e.editVideo,[o,i]=a.useState({title:"",category:"",url:"",description:""}),[l,c]=a.useState(""),[u,d]=a.useState(!1);a.useEffect((()=>{r&&i({title:r.title||"",category:r.category||"",url:r.url||"",description:r.description||""})}),[r]);const p=e=>{const{name:t,value:r}=e.target;i((e=>({...e,[t]:r})))};return x.jsx(xn,{children:x.jsxs(vn,{children:[x.jsx(On,{children:r?"Editar Video":"Nuevo Video"}),x.jsxs(Pn,{onSubmit:async e=>{e.preventDefault(),d(!0),c("");try{r?await $t.put(`${Ht}/${r.id}`,o):await $t.post(Ht,o),t("/")}catch(n){console.error("Error:",n),c("Error al guardar el video. Por favor, intenta de nuevo.")}finally{d(!1)}},children:[x.jsxs(jn,{children:[x.jsx(En,{htmlFor:"title",children:"Título"}),x.jsx(Sn,{type:"text",id:"title",name:"title",value:o.title,onChange:p,required:!0})]}),x.jsxs(jn,{children:[x.jsx(En,{htmlFor:"category",children:"Categoría"}),x.jsxs(Rn,{id:"category",name:"category",value:o.category,onChange:p,required:!0,children:[x.jsx("option",{value:"",children:"Selecciona una categoría"}),x.jsx("option",{value:"Películas",children:"Películas"}),x.jsx("option",{value:"Series",children:"Series"}),x.jsx("option",{value:"Documentales",children:"Documentales"}),x.jsx("option",{value:"Anime",children:"Anime"})]})]}),x.jsxs(jn,{children:[x.jsx(En,{htmlFor:"url",children:"URL del Video (YouTube)"}),x.jsx(Sn,{type:"url",id:"url",name:"url",value:o.url,onChange:p,required:!0})]}),x.jsxs(jn,{children:[x.jsx(En,{htmlFor:"description",children:"Descripción"}),x.jsx(Tn,{id:"description",name:"description",value:o.description,onChange:p,required:!0})]}),l&&x.jsx(An,{children:l}),o.url&&x.jsx(_n,{children:x.jsx(Fr,{url:o.url})}),x.jsx(kn,{type:"submit",disabled:u,children:u?"Guardando...":r?"Guardar Cambios":"Crear Video"})]})]})})},Ln=h`
  * {
    margin: 0;
    padding: 0;
...
`,Un=p.main`
  ...
  flex-direction: column;
  background: #13111b;
`;function Nn(){return x.jsxs(l,{basename:"/trailerflix",children:[x.jsx(Ln,{}),x.jsxs(Dn,{children:[x.jsx(T,{}),x.jsx(Un,{children:x.jsxs(c,{children:[x.jsx(u,{path:"/",element:x.jsx(wn,{})}),x.jsx(u,{path:"/new-video",element:x.jsx(Cn,{})}),x.jsx(u,{path:"/edit-video",element:x.jsx(Cn,{})}),x.jsx(u,{path:"*",element:x.jsx(Navigate,{to:"/",replace:!0})})]})}),x.jsx(I,{})]})]})}O.createRoot(document.getElementById("root")).render(x.jsx(d.StrictMode,{children:x.jsx(Nn,{})}));
//# sourceMappingURL=index-CD5huCl9.js.map
